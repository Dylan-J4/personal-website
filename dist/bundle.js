...
eval("// DOMContentLoaded listener to ensure the DOM is ready before interaction\ndocument.addEventListener('DOMContentLoaded', function () {\n  // Event listeners for form submissions\n  document.getElementById('signup-form').addEventListener('submit', function (e) {\n    e.preventDefault();\n    signUp();\n    document.getElementById('signup-message').textContent = \"Sign-up successful for \".concat(document.getElementById('signup-email').value, \"!\");\n  });\n  document.getElementById('login-form').addEventListener('submit', function (e) {\n    e.preventDefault();\n    login();\n    document.getElementById('login-message').textContent = \"Login Successful\";\n  });\n\n  // Tab Switches\n  document.querySelector('.tab[data-tab=\"signup-tab\"]').addEventListener('click', function () {\n    return switchTab('signup-tab');\n  });\n  document.querySelector('.tab[data-tab=\"tab1\"]').addEventListener('click', function () {\n    return switchTab('tab1');\n  });\n  document.querySelector('.tab[data-tab=\"tab2\"]').addEventListener('click', function () {\n    return switchTab('tab2');\n  });\n  document.querySelector('.tab[data-tab=\"tab3\"]').addEventListener('click', function () {\n    return switchTab('tab3');\n  });\n  function switchTab(tabId) {\n    // Hide all tab contents\n    var contents = document.querySelectorAll('.tab-content');\n    contents.forEach(function (content) {\n      return content.style.display = 'none';\n    });\n\n    // Show the selected tab content\n    var activeTab = document.getElementById(tabId);\n    activeTab.style.display = 'block';\n\n    // Clear signup form data\n    if (tabId === 'signup-tab') {\n      document.getElementById('signup-email').value = '';\n      document.getElementById('signup-password').value = '';\n    }\n  }\n});\n\n//# sourceURL=webpack://personal_website/./src/dom.js?");
